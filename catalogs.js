...
const METRICS_CATALOG = {
  ...
  grossprofit: { tags: ['GrossProfit'], compute: ['revenue', 'cogs'], operation: 'subtract', category: 'P&L', ttm: 'sum', ru: 'Валовая прибыль' }, 
  ...
  nonoperatingincome: { tags: ['OtherIncome', 'OtherNonoperatingIncomeExpense'], category: 'P&L', ttm: 'sum', ru: 'Прочие доходы/расходы' },
  ...
  inventory: { tags: ['InventoryNet', "FIFOInventoryAmount", "OtherInventory"], category: 'Balance', ttm: 'last', ru: 'Запасы' },
  ...
  ppe: { tags: ['PropertyPlantAndEquipmentNet', 'PropertyPlantAndEquipmentAndFinanceLeaseRightOfUseAssetAfterAccumulatedDepreciationAndAmortization'], category: 'Balance', ttm: 'last', ru: 'Основные средства' },
