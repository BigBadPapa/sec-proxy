...
const METRICS_CATALOG = {
  ...
  da: { tags: ['DepreciationDepletionAndAmortization', 'Depreciation', 'DepreciationAndAmortization', 'DepreciationAmortizationAndAccretionNet'], category: 'CashFlow', ttm: 'sum', ru: 'Амортизация и износ' },
