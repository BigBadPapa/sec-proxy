...
const METRICS_CATALOG = {
  ...
  da: { tags: ['DepreciationDepletionAndAmortization', 'Depreciation', 'DepreciationAndAmortization', 'DepreciationAmortizationAndAccretionNet', 'DepreciationAndAmortizationExcludingDebtIssuanceCosts', 'AmortizationOfIntangibleAssets'], category: 'CashFlow', ttm: 'sum', ru: 'Амортизация и износ' },
