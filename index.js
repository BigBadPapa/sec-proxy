...
const METRICS_CATALOG = {
  ...
  da: { tags: ['DepreciationDepletionAndAmortization', 'Depreciation', 'DepreciationAndAmortization', 'DepreciationAmortizationAndAccretionNet'], compute: ['AccretionAmortizationOfDiscountsAndPremiumsInvestments', 'AmortizationOfIntangibleAssets'], operation: 'sum', category: 'CashFlow', ttm: 'sum', ru: 'Амортизация и износ' },
