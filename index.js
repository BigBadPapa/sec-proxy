...
const METRICS_CATALOG = {
  ...
  netchangeincash: { tags: ['CashAndCashEquivalentsPeriodIncreaseDecrease', 'CashCashEquivalentsRestrictedCashAndRestrictedCashEquivalentsPeriodIncreaseDecreaseIncludingExchangeRateEffect'], category: 'CashFlow', ttm: 'sum', ru: 'Чистое изменение денег' },
